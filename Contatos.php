...
<div id="conteudo_contact" class="form_campo">
    <section id="contatos">
        <h2>Contato</h2>
            ...
            <fieldset>
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" type="text" id="contato-nome" placeholder="Informe o nome" name="nome" id="nome" onblur ="validarTeste()">
                    </div>
